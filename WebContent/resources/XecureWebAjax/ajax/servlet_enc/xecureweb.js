...
function PrintObjectTag()
{
	...
	else
	{
		...
		{
			//비스타 컨트롤 (다운로드센타)
			document.write('<OBJECT ID="XecureWeb" CLASSID="CLSID:7E9FDB80-5316-11D4-B02C-00C04F0CD404" CODEBASE="http://download.softforum.co.kr/Published/XecureWeb/v7.2.0.2/xw_install.cab#Version=7,2,0,2"  width=0 height=0>No XecureWeb PlugIn</OBJECT>');
		}
		else
		{
			document.write('<OBJECT ID="XecureWeb" CLASSID="CLSID:7E9FDB80-5316-11D4-B02C-00C04F0CD404" CODEBASE="http://download.softforum.co.kr/Published/XecureWeb/v7.0.9.5/xw_install.cab#Version=7,0,9,5"  width=0 height=0>No XecureWeb PlugIn</OBJECT>');
		}
	}
}
