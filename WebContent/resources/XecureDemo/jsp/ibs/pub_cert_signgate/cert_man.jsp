            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <div align="center"><font face="Times New Roman, Times, serif" size="6">사용자 
                    인증서 조회및 상태변경</font></div>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
                <td valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="2%" height="24" bgcolor="#DEDBCB">&nbsp;</td>
                      <td height="24" bgcolor="#DEDBCB"><b>사용자 확인을 위해서 아래의 정보를 
                        입력해주십시요.</b></td>
                    </tr>
                    <tr> 
...
<br>		
<form name='form1' method=post action='cert_view.jsp' onSubmit='return XecureSubmit(this);'>
                            <table width="417">
                              <tr>
                                <td width="199">계좌번호</td>
                                <td width="206"> 
                                  <input type=text name='account' size='30'></td></tr>
<tr>
                                <td width="199">계좌비밀번호</td>
                                <td width="206"> 
                                  <input type=text name='ac_pwd' size='30'></td></tr>
<tr>
                                <td width="199">패스워드카드 15번째 숫자</td>
                                <td width="206"> 
                                  <input type=text name='pcard' size='30'></td></tr>

<tr>
                                <td width="199">개인 (법인단체) ID </td>
                                <td width="206"> 
                                  <input type=text name='user_id' size='30'></td></tr>
<tr><td colspan=2>또는</td></tr>
<tr>
                                <td width="199">주민등록번호 ( 사업자 등록번호 ) </td>
                                <td width="206"> 
