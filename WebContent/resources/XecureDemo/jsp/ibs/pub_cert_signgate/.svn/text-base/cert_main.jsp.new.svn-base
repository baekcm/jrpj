            ...
            <table width="250" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr>
					  <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_register.jsp" onClick="return XecureLink(this);">인증서 발급</a></td>
              ...
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_request_offline.jsp">참조코드/인가코드 인증서 발급</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
