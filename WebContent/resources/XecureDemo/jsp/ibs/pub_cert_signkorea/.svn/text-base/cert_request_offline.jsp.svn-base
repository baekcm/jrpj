...
{
	nRet = RequestCertificate_signKorea( form.ref_code.value, form.auth_code.value );
	if ( nRet == 0 )
		confirm("증권전산(SignKorea) 공인인증기관으로 부터 인증서를 발급 받았습니다.");
}
</script>
                ...
                <td valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="2%" height="24" bgcolor="#DEDBCB">&nbsp;</td>
                      <td height="24" bgcolor="#DEDBCB">&nbsp;<b>참조 코드와 인가 코드를 
                        입력한후 '확인' 버튼을 누르시면 증권전산(SignKorea) 공인인증기관으로 부터 인증서를 발급받을 
                        수 있습니다.</b></td>
                    </tr>
                    <tr> 
...
참조 코드:<input type=text name='ref_code' size=40 ><br>
