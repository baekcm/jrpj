            ...
            <table width="200" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <tr> 
                <td height="30"> 
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_register_m.jsp" onClick="return XecureLink(this);">[Client] 인증서 발급. 키복구용 인증서 발급(국방부)</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
			  ...
			  <tr> 
                <td height="30"> 
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_pre_register.jsp" onClick="return XecureLink(this);">[Client] 인증서 사전 발급(국방부)</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
			   ...
			   <tr> 
                <td height="30"> 
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_download_req.jsp" onClick="return XecureLink(this);">[Client] 인증서 다운로드 (국방부)</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
			  ...
			  <tr> 
                <td height="30"> 
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_recover.jsp" onClick="return XecureLink(this);">[Client] 키복구 (국방부)</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
