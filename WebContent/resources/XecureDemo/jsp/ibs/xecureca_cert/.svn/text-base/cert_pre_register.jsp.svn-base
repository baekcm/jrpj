            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="40" valign="middle"> 
                  <p align="center"><font size="4" face="Times New Roman, Times, serif">인증서 사전발급 
                  </font></p>
                </td>
              </tr>
              <tr> 
...
<br>
<form name="form1" method=post action='cert_pre_request.jsp' onSubmit='return XecureSubmit(this);'>
<table>
...
<tr><td>기관 코드 </td><td><input type=text name="corp_code" size="20" value="0070" ></td></tr>
<tr><td>조직 코드 - 부대코드 </td><td><input type=text name="org_code" size="20" ></td></tr>
<tr><td>조직구분코드 - 군번 </td><td><input type=text name="orgid_code" size="20"></td></tr>
</table>
<div align="center">
