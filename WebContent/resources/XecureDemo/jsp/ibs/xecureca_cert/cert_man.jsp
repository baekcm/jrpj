            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="6" face="Times New Roman, Times, serif">사용자 인증서 조회 / 상태 변경</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
...
<tr><td>인증서 시리얼 번호(hex)</td><td><input type=text name='cert_serial' size='20'></td></tr>

<tr><td>개인 (법인단체) ID </td><td><input type=text name='user_id' size='20'></td></tr>

<!--<tr><td>주민등록번호 (사업자등록번호) </td><td><input type=text name='ssn' size='20'></td></tr>-->

<tr><td></td><td><input type=hidden name='corp_code' value='0070'></td></tr>
