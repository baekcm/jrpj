...
function cert_revoke(form)
{
   ...
   for(i=0; i<5; i++) {
	 ...
	 nRet = RevokeCertificate ( "12", 0, i + 1 );
	 if ( nRet == 0 ) { 
...
<tr><td colspan=2><b>인증서 폐기</b></td></tr>
<tr><td>사유</td>
...
<input type=radio name='reason' value=6> Certificate Hold </td>
                          ...
                          <div align="center"><br>
                            <input type=image src="../../../img/button_ok.jpg" width="90" height="24" border="0">
                          </div>
                        </form>
</center>
