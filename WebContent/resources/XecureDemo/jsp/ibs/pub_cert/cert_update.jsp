...
*/
	...
	ra_result = sfra.registerUpdateUser ( operaterId, user_type, company_name, user_name, euser_name, user_id, 
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="6" face="Times New Roman, Times, serif">사용자 인증서 갱신(등록) 확인</font></p>
                  </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
...
<br>
<%=request.getParameter("user_name")%>'님의 사용자 정보가 금융결제원 인증기관에 갱신등록 되었습니다. <br>
<br>
  이제 '확인' 버튼을 누르시면 금융결제원 공인인증기관으로 부터 인증서를 갱신할수 있습니다.
<p><font color="#000000" size="5"> </font> </p>
<form name='auth' onSubmit='cert_renew(this); return false;'>
