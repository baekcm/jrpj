            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="6" face="Times New Roman, Times, serif">참조번호/인가코드 조회 결과</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
...
<%
	String certSerial = request.getParameter("serial");
	String userID = request.getParameter("id");

	PublicRA sfra = new PublicRA ( getXecureConfig() );

	int ra_result = sfra.authDataView(certSerial, userID);

	if ( ra_result != 0 ) {
%>
		<p><font color='#000000' size='5'>조회 오류</font></p>
...
%>
		<p><font color='#000000' size='5'>조회 성공</font></p>

		<table>
		
		<tr><td>참조번호</td><td><%=sfra.getResponseFromAuthDataView("REFCODE")%></td></tr>
		<tr><td>인가코드</td><td><%=sfra.getResponseFromAuthDataView("AUTHCODE")%></td></tr>
