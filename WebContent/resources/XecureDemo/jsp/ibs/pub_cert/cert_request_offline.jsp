...
{
	alert("1");
	var nRet = RequestCertificate( "10", form.ref_code.value, form.auth_code.value );
	if ( nRet == 0 )
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="5" face="Times New Roman, Times, serif">참조코드/인가코드 
                    인증서 발급</font></p>
                </td>
              </tr>
              <tr> 
                ...
                <td valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="2%" height="24" bgcolor="#DEDBCB">&nbsp;</td>
                      <td height="24" bgcolor="#DEDBCB"><b>참조코드와 인가코드를 입력한후 &quot;확인&quot;버튼을 
                        누르시면 금융결제원 공인인증기관으로부터 인증서를 발급받을수 있습니다.</b></td>
                    </tr>
                    <tr> 
                      <td colspan="3" height="24"> 
<br>
<form name='auth' onSubmit='cert_request(this); return false'>
                          <div align="center">참조 코드 :
                            <input type=text name='ref_code' size=40 >
                            <br>
                            인가 코드 :
                            <input type=text name='auth_code' size=40 >
                            <br>&nbsp;
                            <br><input type=image src="../../../image/button_ok.jpg" width="90" height="24" border="0">
                          </div>
                        </form>
