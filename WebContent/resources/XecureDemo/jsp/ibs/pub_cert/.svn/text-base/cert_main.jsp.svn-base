            ...
            <table width="250" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr>
					  <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_register.jsp" onClick="return XecureLink(this);">인증서 (재)발급, 갱신등록</a></td>
              ...
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_revoke.jsp" onClick="return XecureLink(this);">인증서 폐기/효력정지</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_man.jsp" onClick="return XecureLink(this);">인증서 조회/상태 변경</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="result_view.jsp" onClick="return XecureLink(this);">접수처리 결과 조회</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="authdata.jsp" onClick="return XecureLink(this);">참조번호/인가코드 조회</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="cert_request_offline.jsp" onClick="return XecureLink(this);">참조코드/인가코드 인증서 발급</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="" onClick="ShowCertManager(); return false;">인증서 관리자</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
			  ...
			  <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr>
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="change_userid_request.jsp" onClick="return XecureLink(this);">사용자 인증서 ID변경</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
			  ...
			  <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="" onClick="DeleteCertificate('id=lluu0000,e=q,cn=lluu0000,ou=q,o=q,l=q,c=KR'); return false;">인증서 삭제</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td height="30">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#9DA3A7" height="24">
                    <tr> 
                      <td bgcolor="#F5F5F5">&nbsp;&nbsp;<a href="del.html" onClick="return EndSession();">세션 삭제</a></td>
                      <td bgcolor="#FFFFFF" width="10%">&nbsp;</td>
                    </tr>
                  </table>
                </td>
