            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="6" face="Times New Roman, Times, serif">참조번호/인가코드 조회</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
...
<div align="center">
<br>
<form name='form1' method=post action='authdata_view.jsp' onSubmit='return XecureSubmit(this);'>
                          <table width="425">
                            <tr>
                              <td width="161">인증서 시리얼(HEXA)</td>
                              <td width="252">
<input type=text name='serial' size='35'></td></tr>
<tr>
                              <td width="161">사용자 아이디</td>
                              <td width="252">
<input type=text name='id' size='35'></td></tr>
</table>
                          <p align="center">
