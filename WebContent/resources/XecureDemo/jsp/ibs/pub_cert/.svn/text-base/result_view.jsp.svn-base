            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="6" face="Times New Roman, Times, serif">접수처리 
                    결과조회</font></p>
                </td>
              </tr>
              <tr> 
...
<form name='form1' method=post action='result_view_op.jsp' onSubmit='return XecureSubmit(this);'>
                          <table width="425">
                            <tr>
                              <td width="161">계좌번호</td>
                              <td width="252">
<input type=text name='account' size='35'></td></tr>
<tr>
                              <td width="161">계좌비밀번호</td>
                              <td width="252">
<input type=text name='ac_pwd' size='35'></td></tr>
<tr>
                              <td width="161">패스워드카드 15번째 숫자</td>
                              <td width="252">
<input type=text name='pcard' size='35'></td></tr>

<tr>
                              <td width="161">등록일시</td>
                              <td width="252">
<input type=text name='reg_date' size='35'></td></tr>
<tr>
                              <td width="161">접수일련번호</td>
                              <td width="252">
<input type=text name='reg_serial' size='35'></td></tr>
<tr>

							  <td width="161">인증정책 식별코드(신전문RA)</td>
                              <td width="252">
<input type=text name='policy_type' size='35'></td></tr>

							  <td width="161">사용자 ID</td>
                              <td width="252">
<input type=text name='user_id' size='35'></td></tr>
</table>
                          <p align="center">
