            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="6" face="Times New Roman, Times, serif">소프트포럼 
                    인증기관 인증서 설치</font></p>
                </td>
              </tr>
              <tr> 
...
<% 
	...
	String caCertFN = getXecureConfig().getPrivateCaCertFN();
		...
		out.println("사설 인증기관 인증서를 읽을 수 없습니다.");
                out.println("서블릿 엔진의 실행 User 가 파일에 접근할 수 있는지 확인하십시요.");
		out.println("<pre>");
