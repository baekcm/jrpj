            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="5" face="Times New Roman, Times, serif">전자봉투 암호화 결과입니다.(FILE, 패스워드)</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
...
<!---BEGIN_ENC--->
<form name=envelopeForm method=post action='env_demo_file_result_kekey.jsp' onSubmit='return XecureSubmit(this);'>
...
<tr>
<td><strong>DeEnvelope할 화일 경로</strong>
</td>
<td>
...
<tr>
<td><strong>DeEnvelope된 내용을 저장할 화일 경로</strong>
</td>
<td>
<input type=text name='fileOut' size=100 value='<%=request.getParameter("fileIn")+".org_key"%>'></input>
</td>
</tr>
<tr>
...
<td>
<input type=text name='passwd' value='<%=request.getParameter("passwd")%>'></input>
</td>
</tr>
<tr>
