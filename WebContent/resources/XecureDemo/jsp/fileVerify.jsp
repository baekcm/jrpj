...
<form name=envelopeForm method=post action='fileSign.jsp' onSubmit='return XecureSubmit(this);'>
                ...
                <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td height="24" bgcolor="#DEDBCB"><b>서명할 화일 경로</b></td>
                      </tr>
                      <tr>
...
%>
                      ...
                      <tr>
                        <td colspan="3" height="24"> 
                          <div align="left"> 
                            <input type=text size=120 name='fileOut' value='<%=fileDir%>demo/file/fileStorage/xw_install.exe.sig'>
                            </input>
                           </div>
                        </td>
                      </tr>
