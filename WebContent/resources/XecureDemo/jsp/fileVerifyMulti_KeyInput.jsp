...
<form name=envelopeForm method=post action='fileSignMulti_KeyInput.jsp' onSubmit='return XecureSubmit(this);'>
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                    <p align="center"><font size="3"><font size="6" face="Times New Roman, Times, serif">다자간 전자 
                      서명 데모(File)</font></font></p>
                    </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
                <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td height="24" bgcolor="#DEDBCB"><b>서명할 화일 경로(서명된 화일)</b></td>
                      </tr>
                      <tr>
...
%>
							<input type=text size=120 name='fileIn' value='<%=fileDir%>demo/file/fileStorage/xw_install.exe.sig'>
                            </input>
                           </div>
                        </td>
                      </tr>
                      <tr> 
                        ...
                        <td height="24" bgcolor="#DEDBCB"><b>서명 저장할 화일 경로</b></td>
                      </tr>
                      <tr>
                        <td colspan="3" height="24"> 
                          <div align="left"> 
                            <input type=text size=120 name='fileOut' value='<%=fileDir%>demo/file/fileStorage/xw_install.exe.sig.multi'>
                            </input>
                           </div>
                        </td>
                      </tr>
					  ...
					  <tr> 
                        ...
                        <td height="24" bgcolor="#DEDBCB"><b>서명추가할 Cert</b></td>
                      </tr>
                      <tr>
                        <td colspan="3" height="24"> 
                          <div align="left"> 
                            <input type=text size=120 name='aCert' value='<%=fileDir%>demo/file/signCert_test.der'>
                            </input>
                           </div>
                        </td>
                      </tr>
					  ...
					  <tr> 
                        ...
                        <td height="24" bgcolor="#DEDBCB"><b>서명추가할 PrivKey</b></td>
                      </tr>
                      <tr>
                        <td colspan="3" height="24"> 
                          <div align="left"> 
                            <input type=text size=120 name='aKey' value='<%=fileDir%>demo/file/signPri_test.key'>
                            </input>
                           </div>
                        </td>
                      </tr>
					  ...
					  <tr> 
                        <td width="2%" height="24" bgcolor="#DEDBCB">&nbsp;</td>
                        <td width="2%" height="24" bgcolor="#DEDBCB"><b>5.</b></td>
                        <td height="24" bgcolor="#DEDBCB"><b>PrivKey 암호</b></td>
                      </tr>
                      <tr>
                        <td colspan="3" height="24"> 
                          <div align="left"> 
                            <input type=text size=120 name='aPasswd' value='1111qqqq'>
                            </input>
                           </div>
                        </td>
                      </tr>
