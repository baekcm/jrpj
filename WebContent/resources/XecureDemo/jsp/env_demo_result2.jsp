...
<%
		...
		enveloped = envelope.deEnvelopeData(request.getParameter("enveloped"));
%>
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="5" face="Times New Roman, Times, serif">전자봉투 복호화 결과입니다.(서버 인증서)</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
