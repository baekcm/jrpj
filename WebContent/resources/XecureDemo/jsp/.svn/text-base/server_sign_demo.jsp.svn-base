...
<form name=signform method=post action='sign_result.jsp' onSubmit='return XecureSubmit(this);'>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td colspan="3" height="24"> 
                          <div align="left"> 
                            <textarea cols=100 rows=15 name='plain'>원문 메시지..... 
이 textarea 의 내용이 서명 됩니다.
                      ...
                      <tr> 
                        <td height="24" colspan="3"> 
                          <p> 
                            <textarea cols=100 rows=15 name='signed_msg'></textarea>
                          </p>
                        </td>
                      </tr>
                      <tr> 
                        <td colspan="3" height="24"> <br>
                          <input type=button value='전자서명 (PKCS#7)' onClick='signform.signed_msg.value = Server_Sign(0, signform.plain.value);' name="Button">
                          <br>
                          <input type=button value='전자서명 (Only Signature)' onClick='signform.signed_msg.value = Server_Sign(1, signform.plain.value);'>
                          <br>
<!-------
                          <input type=button value='전자서명 (no confirm window, log-on certificate only)' onClick='signform.signed_msg.value = Sign_with_option(2,signform.plain.value);'>
                          <br>
                          <input type=button value='전자서명 (confirm window, log-on certificate only)' onClick='signform.signed_msg.value = Sign_with_option(3, signform.plain.value);'>
-------->
                        </td>
                      </tr>
                      <tr> 
