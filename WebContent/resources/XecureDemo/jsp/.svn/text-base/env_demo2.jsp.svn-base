...
<%
		...
		enveloped = envelope.envelopeData_CMS(new String(new XecureLib(this.getXecureConfig()).getServerCertPem()), 
		                                      request.getParameter("plain"));
%>

<title>전자통투 암호화 결과(서버 인증서)</title>
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="5" face="Times New Roman, Times, serif">전자봉투 암호화 결과입니다.(서버 인증서)</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
...
<!---BEGIN_ENC--->
<form name=envelopeForm method=post action='env_demo_result2.jsp' onSubmit='return XecureSubmit(this);'>
