...
<%
		...
		enveloped = envelope.deEnvelopeData(request.getParameter("enveloped_hwinfo_data"));
%>

<title>GetUserHWInfo 복호화 결과</title>
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="5" face="Times New Roman, Times, serif">GetUserHWInfo 복호화 결과입니다.</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
