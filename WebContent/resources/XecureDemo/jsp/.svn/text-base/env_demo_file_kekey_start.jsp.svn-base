...
<form name=envelopeForm method=post action='env_demo_file_kekey.jsp' onSubmit='return XecureSubmit(this);'>
...
%>
                      ...
                      <tr>
                        <td colspan="3" height="24"> 
                          <div align="left"> 
                            <input type=text size=120 name='fileOut' value='<%=fileDir%>demo/file/fileStorage/xw_install.exe.env_key'>
                            </input>
                           </div>
                        </td>
                      </tr>
					  ...
					  <tr> 
                        ...
                        <td height="24" bgcolor="#DEDBCB"><b>패스워드</b></td>
                      </tr>
                      <tr> 
                      <tr> 
                        <td colspan="3" height="1"> 
                          <div align="left"> 
                            <input type=text size='120' name='passwd' value='비밀번호'></input>
                           </div>
                        </td>
                      </tr>
                      <tr> 
