                ...
                <td align="right">
                  <table width="25%" height=20 border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="50%">
                        <div align="center"><a href="enc_client_req_xw.html">이전메뉴</a></div>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font face="Times New Roman, Times, serif" size="4">암호화된 
                    클라이언트 Request 복호화 결과입니다.</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
...
<%=xservlet.encrypt("<p align='center'><big><strong>암호화된 서버 Response 문장입니다. </strong></big></p>")%>
