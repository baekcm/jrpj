...
<%
	SignVerifier	verifier = new SignVerifier ( this.getXecureConfig(), request.getParameter("tsa_msg") );
%>
...
<pre>
<%
	String sm = request.getParameter("tsa_msg"); 
	int i;
...
<tr>
<td width='17%'><strong>타임스탬프 시간</strong></td>
<td width='83%'><strong>
<pre>
