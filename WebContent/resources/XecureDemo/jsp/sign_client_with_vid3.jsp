                ...
                <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td height="24" bgcolor="#DEDBCB"><b>주민등록번호(사업자등록번호) - 공백없이 숫자만 입력</b></td>
                      </tr>
                      <tr> 
...
이 textarea 의 내용이 서명 됩니다.
					  ...
					  <tr> 
                        <td width="2%" height="24" bgcolor="#DEDBCB">&nbsp;</td>
                        <td width="2%" height="24" bgcolor="#DEDBCB"><b>4.</b></td>
                        <td height="24" bgcolor="#DEDBCB"><b>VID 검증을 위한 사용자 주민등록번호(사업자 등록번호)-사용되지 않습니다.</b></td>
                      </tr>
					  <tr> 
                        <td colspan="3" height="24"> 
                          <div align="left"> 
                      ...
                      <tr> 
                        <td colspan="3" height="24"> <br>
                          <input type=button value='전자서명 (no confirm window, all certificates)' onClick='signform.signed_msg.value = Sign_with_vid_web(0, signform.plain.value, s, idn.value); vid_msg.value = send_vid_info();' name="Button">
                          <br>
                          <input type=button value='전자서명 (confirm window, all certificates)' onClick='signform.signed_msg.value = Sign_with_vid_web(1, signform.plain.value, s, idn.value); vid_msg.value = send_vid_info();'>
                          <br>
                          <input type=button value='전자서명 (no confirm window, log-on certificate only)' onClick='signform.signed_msg.value = Sign_with_vid_web(2, signform.plain.value, s, idn.value); vid_msg.value = send_vid_info();'>
                          <br>
                          <input type=button value='전자서명 (confirm window, log-on certificate only)' onClick='signform.signed_msg.value = Sign_with_vid_web(3, signform.plain.value, s, idn.value); vid_msg.value = send_vid_info();'>
                        </td>
                      </tr>
                      <tr> 
                        <td width="2%">&nbsp;</td>
