...
<%
		...
		enveloped = envelope.keKeyDeEnvelopeData(request.getParameter("pwd").getBytes(),request.getParameter("enveloped"));
%>

<title>전자통투 복호화 결과(패스워드)</title>
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td height="120" valign="middle"> 
                  <p align="center"><font size="5" face="Times New Roman, Times, serif">전자봉투 복호화 결과입니다.(패스워드)</font></p>
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
