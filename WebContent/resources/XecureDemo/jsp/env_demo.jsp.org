...
<OBJECT ID="XPSign" CLASSID="CLSID:CAB55A2C-F27B-4B87-8B82-F43F9E37DD37" CODEBASE="/XecureObject/XPSign_Install.cab#Version=1,0,0,2" >
</OBJECT>
...
var rec1 = "";
	...
	rec1 +="MIID8TCCA1qgAwIBAgIDAJPrMA0GCSqGSIb3DQEBBQUAME0xCzAJBgNVBAYTAmty\n";
	rec1 +="MRAwDgYDVQQKEwd5ZXNzaWduMRMwEQYDVQQLEwpMaWNlbnNlZENBMRcwFQYDVQQD\n";
	rec1 +="Ew55ZXNzaWduQ0EtVEVTVDAeFw0wNDAyMTgxNTAwMDBaFw0wNDAzMTkxNDU5MDBa\n";
	rec1 +="MHExCzAJBgNVBAYTAmtyMRAwDgYDVQQKEwd5ZXNzaWduMREwDwYDVQQLEwhwZXJz\n";
	rec1 +="b25hbDESMBAGA1UECxMJU09GVEZPUlVNMSkwJwYDVQQDEyAyMDA0MDIxOWt5aDAx\n";
	rec1 +="KCkwMDkwMjAwNDAyMTlreWgwMTCBnzANBgkqhkiG9w0BAQEFAAOBjQAwgYkCgYEA\n";
	rec1 +="wVylad8q+60TvRzlDdw++Q3Rp7o9t2BYdYA6taxyjkl+lJp8ITGSWIUXKqdzi+6a\n";
	rec1 +="2nOtAgTH8/PV60Ea3Jr5LBT1lZp0DlQgwgVmdAt43GjY7sbQICoV3MCzq3swHfOa\n";
	rec1 +="sM5XGACuXAfQaMbkST29Im2lXfnmOhpGBYQ4+hWCIvkCAwEAAaOCAbkwggG1MB8G\n";
	rec1 +="A1UdIwQYMBaAFMCrHfoXAVmyKk1zrUu+0tjN9pzFMB0GA1UdDgQWBBT6bIEOQdyp\n";
	rec1 +="f9pSN217iyPWRzYPfjAOBgNVHQ8BAf8EBAMCBsAweQYDVR0gAQH/BG8wbTBrBgkq\n";
	rec1 +="gxqMmkUBAQEwXjAuBggrBgEFBQcCAjAiHiDHdAAgx3jJncEcspQAIKz1x3jHeMmd\n";
	rec1 +="wRwAIMeFssiy5DAsBggrBgEFBQcCARYgaHR0cDovL3d3dy55ZXNzaWduLm9yLmty\n";
	rec1 +="L2Nwcy5odG0wXAYDVR0RBFUwU6BRBgkqgxqMmkQKAQGgRDBCDA0yMDA0MDIxOWt5\n";
	rec1 +="aDAxMDEwLwYKKoMajJpECgEBATAhMAcGBSsOAwIaoBYEFJKWPip0YprG7vZWSono\n";
	rec1 +="Az8eBsBJMFIGA1UdHwRLMEkwR6BFoEOGQWxkYXA6Ly8yMDMuMjMzLjkxLjIzNDo2\n";
	rec1 +="MDIwL291PWRwNnA1MSxvdT1MaWNlbnNlZENBLG89eWVzc2lnbixjPWtyMDYGCCsG\n";
	rec1 +="AQUFBwEBBCowKDAmBggrBgEFBQcwAYYaaHR0cDovLzIwMy4yMzMuOTEuMjMzOjQ2\n";
	rec1 +="MTIwDQYJKoZIhvcNAQEFBQADgYEAXoks2B05GhK3gsRZp2rVR24PnbBn4vsL8FXM\n";
	rec1 +="dPxDEEsddllRwgTK1AEGSXMQFMDC2iny/WRjQ/NZP0WevuDddYeQEJFo55e2qPg2\n";
	rec1 +="fXcCPJmPE2mS0Vuy5kdr4aJhCFrNtrQ5i4I/Qm5V2MyGdYEMPwjEWiwagySrqaSe\n";
	rec1 +="v45JhT8=\n";
