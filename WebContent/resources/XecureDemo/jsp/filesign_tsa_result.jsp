...
<%
	String ca_dn_list = request.getParameter("ca_dn_list");
        FileSignVerifier    verifier = null;

        if (ca_dn_list == null || ca_dn_list.equals("")) {
                verifier = new FileSignVerifier ( this.getXecureConfig(), request.getParameter("filePath"));
        } else {
                verifier = new FileSignVerifier ( this.getXecureConfig(), request.getParameter("filePath"), ca_dn_list, "");
        }
%>
...
<tr>
<td width='17%'><strong>서명자 userid</strong></td>
<td width='83%'><strong>
<pre>
<%=verifier.getUserID()%>
</pre>
...
<tr>
<td width='17%'><strong>타임스탬프 메시지</strong></td>
<td width='83%'><strong>
<pre>
<%=verifier.getTimeStampMsg()%>
</pre>
</strong></td>
</tr>
<tr>
<td width='17%'><strong>타임스탬프 정확도</strong></td>
<td width='83%'><strong>
<pre>
<%=verifier.getTimeStampAccuracy()%>
</pre>
</strong></td>
</tr>
<tr>
