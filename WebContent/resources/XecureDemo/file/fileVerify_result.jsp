...
<%
	String ca_dn_list = request.getParameter("ca_dn_list");
        ...
        if (ca_dn_list == null || ca_dn_list.equals("")) {
                verifier = new FileSignVerifier ( this.getXecureConfig(), request.getParameter("plain"));
        } else {
                verifier = new FileSignVerifier ( this.getXecureConfig(), request.getParameter("plain"), ca_dn_list, "");
        }
%>
