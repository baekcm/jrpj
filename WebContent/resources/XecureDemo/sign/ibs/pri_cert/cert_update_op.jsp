...
<html>
<head><title> Softforum 사용자 인증서 변경 결과 </title>
</head>
...
%> 
  <!-- Title -->
  <p><font size="6"><font color="#6699CC"><b>사용자 인증서 변경 결과</b></font></font></p>
  <p>&nbsp;</p>
    <p>사용자 : <%=user_name%> 님 </p>
    <p>계좌번호 : <%=account%></p>
    <p>사용자 ID : <%=user_id%></p>
    <p><%=request.getParameter("user_name")%>'님의 사용자 인증서가 소프트포럼 인증기관으로 부터 변경 되었습니다. </p><br>
