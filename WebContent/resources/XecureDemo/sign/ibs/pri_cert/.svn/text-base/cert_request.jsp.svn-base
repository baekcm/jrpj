...
<html>
<head><title> 소프트포럼 인증기관 : 인증서 발급 신청 </title>
</head>
...
<!-- Title -->
<p><font size="6"><font color="#6699CC"><b>소프트포럼 인증기관 : 인증서 발급 신청</b></font></font></p>
<p><font color="#000000" size="5">사용자 확인을 위해서 아래의 정보를 입력해 주십시오.</font></p>

<form name="form1" method=post action='cert_request_op.jsp' onSubmit='cert_req.value=GenCertReq();'>
