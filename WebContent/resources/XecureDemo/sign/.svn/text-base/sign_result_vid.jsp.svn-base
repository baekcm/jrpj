...
<table border='1' width='100%'>
	...
	<!-- 	// request.getParameter("signed_msg");  -->
	
	<%
	

	String sm = new String(request.getParameter("signed_msg").getBytes("8859_1"),"KSC5601"); 
...
<h1>식별번호 검증 메세지</h1>
<form name='vid_form_result' method=post action='virtual_id_result.jsp'>
<textarea cols=100 rows=15 name='vid_msg'>
</textarea><br>
<input type=submit value="전송">
</form>
<script language='javascript'>
<%=vid.VerifyVidScript(verifier.getSignerCertificate().getSubject())%>
