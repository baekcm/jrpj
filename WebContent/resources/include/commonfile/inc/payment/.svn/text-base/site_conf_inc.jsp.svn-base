...
<%
    ...
    */
    String g_conf_home_dir  = dftFilePath + dtpFilePath;                  // BIN 절대경로 입력 (bin전까지) 
    String g_conf_key_dir   = dftFilePath + dtpFilePath +  confKey;    // 공개키 파일 절대경로 
    String g_conf_log_dir   = dftFilePath + dtpFilePath + File.separator + "log";             // LOG 디렉토리 절대경로 입력
