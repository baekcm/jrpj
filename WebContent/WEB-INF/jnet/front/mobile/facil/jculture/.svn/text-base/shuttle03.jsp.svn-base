...
<div id="body"> 
	...
	<div class="ttabWrap">
		<ul id="ttab3">
			...
			<li class="choiced"><a href="shuttle03">3호차</a></li>
		</ul>
	</div>
	<!-- tabMaker  --> 
	<!--real Contents S-->
	<div class="pageSection">
		<ul class="guide">
			<li><strong>셔틀버스 노선 안내</strong>
				<ul>
					<li><strong>평일</strong>: 16:00 / 16:30 / 17:00 / 17:30 / 18:00 / 18:30 / 19:00 / 19:30 / 20:00 /20:30 /21:00 /21:30
						<p>※ 교통사정에 따라 도착시간이 지연 될 수 있으니 <strong>5분 일찍 나와서</strong> 기다려 주시기 바랍니다.</p>
						<p class="point_red01"><strong>※ 토요일, 일요일은 운행 안함 </strong></p>
						<p class="point_red01"><strong>※ 16시 ~ 21:30분 차량까지 연세우리소아과, 경복궁역(1번 출구), 사직동사무소 매시간 2회 운행 합니다. </strong></p>
					</li>
					<li>12인승 셔틀버스 기사 : 011-9349-8700</li>
					<li>종로문화체육센터 : 02)732 - 9393</li>
					<!-- 12인승 노선 관련 정보 시작 -->
					<li><strong>12인승 셔틀버스 노선도</strong>
						<ul>
							<li class="none"><img src="/resources/include/commonfile/image/content/jculture/mini_nosun.gif" alt="12인승 셔틀 버스 노선도 ( 노선도의 상세 내용은 아래의 노선도 표를 참고)" /></li>
							<li class="none">
								<div class="tblWrap">
									<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="셔틀의 출발위치 및 도착시간, 정류소 사진 보기를 정리한 표. " class="tbl01 tdCenter">
										...
										<tbody>
											...
											<tr>
												<td>혜담 부동산(독립삼호아파트 앞)</td>
												<td>20</td>
											</tr>
											<tr>
												<td>무악현대아파트 정문(경순슈퍼 앞)</td>
												<td>24</td>
											</tr>
											<tr>
												<td>인왕산 아이파크(현대부동산 앞)</td>
												<td>26</td>
											</tr>
											<tr>
												<td>극동 아파트(농수산물 할인마트 앞)</td>
												<td>32</td>
											</tr>
											<tr>
												<td>행촌의원</td>
