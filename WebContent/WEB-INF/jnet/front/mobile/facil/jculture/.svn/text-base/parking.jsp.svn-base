	...
	<div class="pageSection">
		<ul class="guide">
			<li><strong>주차장 이용시간안내</strong>
				<ul>
					<li><span class="point_blue01"><strong>09:00~18:00</strong></span></li>
				</ul>
			</li>
			<li><strong>주차요금</strong>
				<ul>
					<li><strong>기본 30분 1,000원, <span class="point_red02">초과 10분당 500원</span></strong></li>
					<li> <strong>회원요금</strong> : <span class="point_blue01">3시간 무료</span> (프로그램 이용요일만 가능)
						<ul>
							<li>단 , 문의 · 접수 · 자녀등하원 등의 이용 시 고객지원실 또는 사무실에서 방문확인하시면 무료입니다.</li>
							<li>주차는 전자태그 부착차량만 입장 가능합니다.</li>
							<li>요일제부착 차량도 주차 전자태그를 부착하셔야 합니다.</li>
							<li>서울 차량은 전자테그 부착 차량만이 이용 가능</li>
						</ul>
					</li>
				</ul>
			</li>
