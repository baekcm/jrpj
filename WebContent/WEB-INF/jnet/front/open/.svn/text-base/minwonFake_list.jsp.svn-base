...
<div id="middle">
 ...
 공단과 무관한 내용, 상업성, 저속한 표현, 명예훼손, 반사회적인 글과 직원 또는 특정인에 대한 실명기재, 비방, 동일 건에 대한 반복 등의 글은 예고 없이 삭제 또는 비공개로 전환될 수 있습니다. <br />
비공개로 등록된 민원은 목록에 표시되지 않으며, [나의민원보기]에서만 확인이 가능합니다.
</p>
<p class="infom">민원상담 접수 후 [답변중/답변완료]인 상태가 되면 삭제/수정할 수 없습니다.
</p>
				</div>
				<!-- real Contents -->
				<div class="pageSection"> 
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bd00 bd00Bbs" summary="번호,시설명, 분류, 제목, 조회수의 자주 묻는 질문의 목록표">
							...
							<tbody>
								<tr>
									<td>5</td>
									<td>동부여성문화센터</td>
									<td class="title"><a href="minwonFake_view.jsp">동부여성 문화센터는 여자만 이용가능한가요?</a></td>
									<td>이○○</td>
									<td>2013.11.30</td>
									<td>접수대기</td>
									<td>323</td>
								...
								<tr>
									<td>4</td>
									<td>청소년문화센터</td>
									<td class="title"><a href="minwonFake_view.jsp">청소년 문화센터 내 취식 금지 아닌가요?</a></td>
									<td>이○○</td>
									<td>2013.11.30</td>
									<td>답변완료</td>
									<td>222</td>
								...
								<tr>
									<td>3</td>
									<td>문화체육센터</td>
									<td class="title"><a href="minwonFake_view.jsp">문화체육센터 셔틀 버스 운영 시간에 대해 문의 드립니다.</a></td>
									<td>이○○</td>
									<td>2013.11.30</td>
									<td>접수대기</td>
									<td>222</td>
								...
								<tr>
									<td>2</td>
									<td>종로구민회관</td>
									<td class="title"><a href="minwonFake_view.jsp">종로구민회관 강당 대여를 신청하고 싶습니다.</a></td>
									<td>이○○</td>
									<td>2013.11.30</td>
									<td>답변중</td>
									<td>222</td>
								...
								<tr>
									<td>1</td>
									<td>종로구민회관</td>
									<td class="title"><a href="minwonFake_view.jsp">종로구민 회관 내의 사과나무의 사과는 언제 따나요?</a></td>
									<td>이○○</td>
									<td>2013.11.30</td>
									<td>답변중</td>
									<td>222</td>
					...
					<div class="btn_farm2 mt20 mb20">
							<!-- Text Button --> 
							<span class="txtBtn_Gray"><a href="/open/minwon_main.jsp" >민원신청하기</a></span> 
							<!-- Text Button --> 
							<!-- Text Button --> 
							<span class="txtBtn_lightGray"><a href="/open/minwon_list.jsp" >전체목록으로</a></span> 
							<!-- Text Button --> 
					</div>
				</div>
