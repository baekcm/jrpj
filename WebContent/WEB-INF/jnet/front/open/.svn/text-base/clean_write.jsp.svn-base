		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="boardWrap">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="제목,작성자, 습득 및 분실일, 습득 및 분실장소, 보관 유무와 내용으로 이루어진 정보를 기입하기 위한 표" class="bd00view">
						...
						<tr>
							...
							<td class="bd01td"><span class="bd01td listx">
								<input name="blostTel" id="blostPlace" type="text" />
							</span></td>
						</tr>
						<tr>
							<th class="ta_l" scope="row"><label for="blostDate">이메일</label></th>
							<td class="bd01td"><span class="bd01td listx">
								<input name="bEmail" id="blostDate" type="text" />
								</span></td>
						</tr>
						<tr>
				...
				<div class="btn_farm2 mt20 mb20"> 
					<!-- Text Button --> 
					<span class="txtBtn_lightGray"><a href="clean_main.jsp" onClick="alert('클린신고 작성을 완료하였습니다.')">작성</a></span> &nbsp;
					<span class="txtBtn_lightGray"><a href="clean_main.jsp" >취소</a></span> 
					<!-- Text Button --> 
				</div>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
