				...
				<div class="boardWrap">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="제목,작성자를 포함한 게시물 상세보기의 표" class="bd00view">
						...
						<tr>
							...
							<td class="bd01td listx">체육관 프로그램 배드민턴 이용요금에 대하여 답변 드립니다 </td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" scope="row" class="bd01tdC"><p>안녕하십니까! 고객님. <br />
							우선 저희 생활관에 많은 관심을 가져주시고 이용을 해주시는데 대하여 감사의 말씀을 드립니다. <br /><br />
							저희 생활관에서는 프로그램을 운영시 금액 책정을 조례를 바탕으로 적정 금액을 책정하고 있으며, 생활관 대체육관 운영을 위해 기존 07시, 09시 배드민턴 프로그램을 바탕으로 06시 배드민턴 프로그램의 금액을 책정 한 것임을 알려 드립니다. <br /><br />
							고객님께서 이점을 양지하여 주시기 바랍니다. <br />
							앞으로도 저희 생활관에 더욱더 많은 관심을 가져주시면 감사하겠습니다. <br />
							요즘 날씨가 무척 쌀쌀해졌습니다. <br />
							항상 건강에 유의하시고 하시는 모든 일에 행운이 가득하시길 기원합니다. <br /><br />
							감사합니다. </p></td>
						</tr>
					</table>
				</div>
