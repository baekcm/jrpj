					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="제목,작성자, 습득 및 분실일, 습득 및 분실장소, 보관 유무와 내용으로 이루어진 정보를 기입하기 위한 표" class="bd00view">
						...
						<tr>
							...
							<td class="bd01td"><span class="bd01td listx">
								<input name="bwriter" type="text" id="bwriter" value="김을동" />
								</span></td>
						</tr>
						<tr>
							...
							<td class="bd01td">
								...
								<label for="divsion2"><input name="radio" type="radio" id="divsion2" value="2" checked="checked" />
							<strong>주민제안</strong></label></td>
						</tr>
						<tr>
							<th scope="row" class="ta_l"><label for="btitle">제안제목</label></th>
							<td class="bd01td"><input name="btitle" id="btitle" value="종로의 영웅 김두한 기념관 건립 사업 제안" size="73" maxlength="60" align="absmiddle" /></td>
						</tr>
						<tr>
							<th class="ta_l" scope="row">내용</th>
							<td class="bd01tdD"><ul class="guide">
									<li><strong>개요/목적</strong>
										<p><textarea name="textarea1" cols="70" rows="10" title="개요/목적 입력">종로하면 
가장 먼저 떠 오르는 건 김두한.
...
야인시대의 테마파크화.
									...
									<li><strong>현황/문제점</strong>
										<p><textarea name="textarea2" cols="70" rows="10" title="현황/문제점 입력">돈이 없다.</textarea></p>
									</li>
									<li><strong>개선방안</strong>
										<p><textarea name="textarea3" cols="70" rows="10" title="개선방안 입력">연말만 되면 멀쩡한 도로 뜯어서 고치지 말고...</textarea></p>
									</li>
									<li><strong>기대효과</strong>
										<p><textarea name="textarea3" cols="70" rows="10" title="기대효과 입력">관광수입?</textarea></p>
									</li>
								</ul></td>
						</tr>
						<tr>
				...
				<div class="btn_farm2 mt20 mb20"> 
					<!-- Text Button --> 
					<span class="txtBtn_lightGray"><a href="sugest_view.jsp" onclick="javascript:submit();">신청확인</a></span> &nbsp; <span class="txtBtn_lightGray"><a href="/open/sugest_list.jsp" >취소</a></span> 
					<!-- Text Button --> 
				</div>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
