...
//<![CDATA[
    ...
    function goYear(){
		$.ajax({
	           type:"POST", 
	           url: "/front/findYear",
	           data : {"title" : "assessment_", "year":$("#pgtschgoYear").val()},
			...
			<div class="contents"> 
				...
				<div class="pageSection"> 
					...
					<div class="pageTopSearch">
						<div class="fl">
							<form name="pgtschEmpl" method="post" action="assessment_last.jsp">
...
<script type="text/javascript">initMenu(6,2,4,0);</script>
</body>
</html>