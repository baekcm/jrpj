...
//<![CDATA[
    ...
    function goYear(){
		$.ajax({
	           type:"POST", 
	           url: "/front/findYear",
	           data : {"title" : "satisfaction_", "year":$("#pgtschgoYear").val()},
		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="pageTopSearch">
					<div class="fl">
						<form name="pgtschEmpl" method="post" action="satisfaction_last.jsp">
...
<script type="text/javascript">initMenu(6,2,6,0);</script>
</body>
</html>