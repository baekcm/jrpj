...
//<![CDATA[
    ...
    function goYear(){
		$.ajax({
	           type:"POST", 
	           url: "/front/findYear",
	           data : {"title" : "settlement_", "year":$("#pgtschgoYear").val()},
			...
			<div class="contents"> 
				...
				<div class="pageSection"> 
					...
					<div class="pageTopSearch">
						<div class="fl">
							<form name="pgtschEmpl" method="post" action="settlement_last.jsp">
...
<script type="text/javascript">initMenu(6,2,3,0);</script>
</body>
</html>