		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="boardWrap">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="제목,작성자를 포함한 게시물 상세보기의 표" class="bd00view">
						...
						<tr>
							...
							<td colspan="3" class="bd01td">경영공시</td>
						</tr>
						<tr>
							<th class="bd01th" scope="row">제목</th>
							<td colspan="3" class="bd01td listx">2013년 10월 체결분 수의계약 내역 공개</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3" class="bd01td">10월_체결분수의계약내역공개.xls<img src="/resources/include/commonfile/image/board/b_ic_excel.gif" alt="파일형식별alt값" /></td>
						</tr>
						<tr>
							<td colspan="4" scope="row" class="bd01tdC"><p><img src="/resources/include/commonfile/image/attached/contract_ex.jpg" alt="제목을 alt값으로" /></p>
								<p>&nbsp;</p>
								<p>2013년 10월 체결 된 수의계약 내역을 붙임과 같이 공개합니다.</p></td>
						</tr>
					</table>
				</div>
				<div class="btn_farm2 mt20 mb20"> 
					<!-- Text Button --> 
					<span class="txtBtn_lightGray"><a href="contract_list.jsp" >목록으로</a></span> 
					<!-- Text Button --> 
				</div>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="이전글과 다음글의 제목으로 구성된 표 제목" class="prevNext">
					...
					<tr>
						<th scope="row">이전글</th>
						<td class="listx"><a href="#">2013년 8월 체결분 수의계약 내역 공개</a></td>
					</tr>
					<tr>
						<th  scope="row">다음글</th>
						<td class="listx"><a href="#">2013년 11월 체결분 수의계약 내역 공개</a></td>
					</tr>
				</table>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
