...
<%
    ...
    /* = -------------------------------------------------------------------------- = */
%>
	<%@ include file="/resources/include/commonfile/inc/payment/site_conf_inc.jsp" %>
<%
    ...
    <script type="text/javascript">
		...
		*/
        ...
        function  jsf__pay( form )
        {
            ...
            {
                openwin = window.open( "/front/mypage/payment/paymentProc", "proc_win", "width=449, height=209, top=300, left=300" );
                RetVal = true ;
            }
...
<form name="order_info" method="post" action="/front/mypage/payment/orderProc" >
<input type="hidden" name="yymm" value="<%//=yymm%>" />
<input type="hidden" name="strpayAmt" value="<%//=strpayAmt%>" />
<input type="hidden" name="strdcAmt" value="<%//=strdcAmt%>" />
<input type="hidden" name="strdc_cd" value="<%//=strdc_cd%>" />
<input type="hidden" name="spayAmt" value="<%//=spayAmt%>" />
<input type="hidden" name="pgmstr" value="<%//=pgmstr%>" />
<input type="hidden" name="orderBasketCnt" id="orderBasketCnt" value="${orderInfo.orderBasketCnt}" />
<input type="hidden" name="orderAmount" id="orderAmount" value="${orderInfo.orderAmount}" />
<input type="hidden" name="pay_method" id="pay_method" value="100000000000" />
<input type="hidden" name="up_id" id="up_id" value="${orderInfo.up_id }" />
<input type="hidden" name="upId" id="upId" value="${orderInfo.up_id }" />
...
%>
                    ...
                    <tr>
                        ...
                        <td class="ta_l"><input type="text" name="ordr_idxx" style="width:300px;height:20px;border:0px" value="${orderInfo.orderNo}" maxlength="40" readonly="readonly"/></td>
                    </tr>
                    <!-- 상품명(good_name) -->
                    <tr>
                        <th scope="row">상품명</th>
                        <td class="ta_l"><input type="text" name="good_name" style="width:300px;height:20px;border:0px" value="${orderInfo.orderPgmNm}" readonly="readonly"/></td>
                    </tr>
                    <!-- 결제금액(good_mny) - ※ 필수 : 값 설정시 ,(콤마)를 제외한 숫자만 입력하여 주십시오. -->
                    <tr>
                        <th scope="row">결제 금액</th>
                        <td class="ta_l">
                        <input type="text" style="width:80px;height:20px;border:0px" value="<fmt:formatNumber value="${orderInfo.orderAmount}" pattern="#,###"/>" readonly="readonly"/>원
                        <input type="hidden" name="good_mny" value="${orderInfo.orderAmount}" />
                        </td>
                    </tr>
                    <!-- 주문자명(buyr_name) -->
                    <tr>
                        <th scope="row">주문자명</th>
                        <td class="ta_l"><input type="text" name="buyr_name" style="width:300px;height:20px;border:0px" value="${orderInfo.orderer}" readonly="readonly"/></td>
                    </tr>
                    <!-- 주문자 E-mail(buyr_mail) -->
                    <tr>
                        <th scope="row">E-mail</th>
                        <td class="ta_l"><input type="text" name="buyr_mail" style="width:300px;height:20px;border:0px" value="${orderInfo.ordererEmail}" maxlength="30" readonly="readonly"/></td>
                    </tr>
                    <!-- 주문자 연락처1(buyr_tel1) -->
                    <tr>
                        <th scope="row">전화번호</th>
                        <td class="ta_l"><input type="text" name="buyr_tel1" style="width:300px;height:20px;border:0px" value="${orderInfo.ordererTel}" readonly="readonly"/></td>
                    </tr>
                    <!-- 휴대폰번호(buyr_tel2) -->
                    <tr>
                        <th scope="row">휴대폰번호</th>
                        <td class="ta_l"><input type="text" name="buyr_tel2" style="width:300px;height:20px;border:0px" value="${orderInfo.ordererHp}" readonly="readonly"/></td>
                    </tr>
                    </table>
					</div>
                    <!-- 결제 요청/처음으로 이미지 -->
                    <div class="btn_farm2 mt20 mb20"> 
                      <input name="" type="submit" class="submit" value="결제진행" onclick="return jsf__pay(this.form);"/>
                      
                      <input name="" type="submit" class="submit" value="이전으로" onclick="javascript:window.location.href='/front/mypage/basketList'"/>
                    </div>
...
%>
    ...
    <input type="hidden" name="site_cd"         value="${ payment.g_conf_site_cd }" />
    <input type="hidden" name="site_name"       value="${ payment.g_conf_site_name }" />
<%
    /*
