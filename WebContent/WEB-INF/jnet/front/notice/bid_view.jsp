		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="boardWrap">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="제목,작성자를 포함한 게시물 상세보기의 표" class="bd00view">
						...
						<tr>
							...
							<td colspan="3" class="bd01td">입찰정보</td>
						</tr>
						<tr>
							<th class="bd01th" scope="row">제목</th>
							<td colspan="3" class="bd01td listx">생활관 수영장 1차 여과기 여재 교체 공사</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3" class="bd01td">공고문.xls<img src="/resources/include/commonfile/image/board/b_ic_excel.gif" alt="파일형식별alt값" /><br/>시방서.xls<img src="/resources/include/commonfile/image/board/b_ic_excel.gif" alt="파일형식별alt값" /></td>
						</tr>
						<tr>
							<td colspan="4" scope="row" class="bd01tdC"><p><img src="/resources/include/commonfile/image/attached/sur_01.jpg" alt="제목을 alt값으로" /></p>
								<p>&nbsp;</p>
								<p>생활관 수영장 1차 여과기 여재 교체 공사 소액견적공고를 아래와 같이 시행합니다.<br/>1. 공고기간 : 2013 .11. 11 ~ 2013. 11. 13<br/>2. 개찰일시 : 2013 .11. 13 17:00<br/>3. 세부사항 : 공고문 참조</p></td>
						</tr>
					</table>
				</div>
				<div class="btn_farm2 mt20 mb20"> 
					<!-- Text Button --> 
					<span class="txtBtn_lightGray"><a href="bid_list.jsp" >목록으로</a></span> 
					<!-- Text Button --> 
				</div>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="이전글과 다음글의 제목으로 구성된 표 제목" class="prevNext">
					...
					<tr>
						<th scope="row">이전글</th>
						<td class="listx"><a href="#">[문화체육센터] 생활관팀 불용물품 매각 전자입찰 재공고 </a></td>
					</tr>
					<tr>
						<th  scope="row">다음글</th>
						<td class="listx"><a href="#">[문화체육센터] 문화체육센터 피아노교실 방음 공사 견적 제출 공고 </a></td>
					</tr>
				</table>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
...
<script type="text/javascript">initMenu(5,3,0,0);</script>
</body>
</html>