				...
				<div class="boardWrap">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="제목,작성자를 포함한 게시물 상세보기의 표" class="bd00view">
						...
						<tr>
							...
							<td colspan="3" class="bd01td">보도자료</td>
						</tr>
						<tr>
							<th class="bd01th" scope="row">제목</th>
							<td colspan="3" class="bd01td listx">시정신문-종로구공단, '파도앙상블'문화나눔(20131017)</td>
						</tr>
						<tr>
...
-->                        
						...
						<tr>
							<td colspan="4" scope="row" class="bd01tdC"><p><img src="/resources/include/commonfile/image/attached/press_01.jpg" alt="제목을 alt값으로" /></p>
								<p>&nbsp;</p>
								<p>시정신문 - 종로구공단, 파도앙상블 문화나눔 - <strong><font color="#FF0000"><a href="http://www.sijung.co.kr/news/articleView.html?idxno=84186" target="_blank" title="새 창 열림">기사보기</a></font></strong></p></td>
						</tr>
					</table>
				</div>
				<div class="btn_farm2 mt20 mb20"> 
					<!-- Text Button --> 
					<span class="txtBtn_lightGray"><a href="press_list.jsp" >목록으로</a></span> 
					<!-- Text Button --> 
				</div>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="이전글과 다음글의 제목으로 구성된 표 제목" class="prevNext">
					...
					<tr>
						<th scope="row">이전글</th>
						<td class="listx"><a href="#">위키트리-하루 30분, 이제는 운동도 스마트시대(20131002) </a></td>
					</tr>
					<tr>
						<th  scope="row">다음글</th>
						<td class="listx"><a href="#">시정신문-종로구공단, '파도앙상블'문화나눔(20131017)</a></td>
					</tr>
				</table>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
