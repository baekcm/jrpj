			...
			<div class="contents"> 
				...
				<div class="pageSection"> 
					...
					<div class="pageTopSearch">
						<form name="pgtSearch" method="post" action="/notice/bid_list.jsp">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bd00 bd00Bbs" summary="번호,시설명, 분류, 제목, 조회수의 게시물의 목록표">
							...
							<tbody>
								<tr>
									<td>10</td>
									<td>종로구민회관</td>
									<td class="title"><a href="bid_view.jsp">생활관 수영장 1차 여과기 여재 교체 공사</a></td>
									<td>1221</td>
								</tr>
								<tr>
									<td>9</td>
									<td>문화체육센터</td>
									<td class="title"><a href="bid_view.jsp">생활관팀 불용물품 매각 전자입찰 재공고 </a></td>
									<td>23</td>
								</tr>
								<tr>
									<td>8</td>
									<td>청소년문화센터</td>
									<td class="title"><a href="bid_view.jsp">마로니에 공원 카페 제안서 평가 위원별 점수 공개 </a></td>
									<td>323</td>
								</tr>
								<tr>
									<td>7</td>
									<td>올림픽기념국민생활관</td>
									<td class="title"><a href="bid_view.jsp">구민회관 헬스기구 매각 공고 </a></td>
									<td>1221</td>
								</tr>
								<tr>
									<td>6</td>
									<td>삼청테니스장</td>
									<td class="title"><a href="bid_view.jsp">마로니에 공원 카페 사용수익 사용자 선정 긴급공고 </a></td>
									<td>23</td>
								</tr>
								<tr>
									<td>5</td>
									<td>동부여성문화센터</td>
									<td class="title"><a href="bid_view.jsp">한미빌딩 공영(노상)주차장 사용수익허가 사용자 선정 </a></td>
									<td>323</td>
								</tr>
								<tr>
									<td>4</td>
									<td>청소년문화센터</td>
									<td class="title"><a href="bid_view.jsp">원서공원 공영(노상)주차장 사용수익허가 사용자 선정 </a></td>
									<td>222</td>
								</tr>
								<tr>
									<td>3</td>
									<td>문화체육센터</td>
									<td class="title"><a href="bid_view.jsp">생활관 불용물품 매각 재공고 </a></td>
									<td>222</td>
								</tr>
								<tr>
									<td>2</td>
									<td>종로구민회관</td>
									<td class="title"><a href="bid_view.jsp">생활관 비상발전기 매각 재공고 </a></td>
									<td>222</td>
								</tr>
								<tr>
									<td>1</td>
									<td>종로구민회관</td>
									<td class="title"><a href="bid_view.jsp">생활관 대체육관 흡음보드 설치공사 </a></td>
									<td>222</td>
								</tr>
							</tbody>
						</table>
