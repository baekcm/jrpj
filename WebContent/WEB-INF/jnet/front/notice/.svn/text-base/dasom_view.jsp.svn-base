		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="boardWrap">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="제목,작성자를 포함한 게시물 상세보기의 표" class="bd00view">
						...
						<tr>
							...
							<td colspan="3" class="bd01td listx">종로다솜 &lt;통권 제12호&gt;</td>
						</tr>
						<tr>
						...
						<tr>
							<th class="bd01th" scope="row">첨부</th>
							<td colspan="3" class="bd01td">dasom[vol13].pdf</td>
						</tr>
						<tr>
							<td colspan="4" scope="row" class="bd01tdC"><p><img src="/resources/include/commonfile/image/attached/dasom_01.jpg" alt="제목을 alt값으로" /></p>
								<p>&nbsp;</p>
								<p>종로다솜 &lt;통권 제12호&gt;</p></td>
						</tr>
					</table>
				...
				<div class="btn_farm2 mt20 mb20"> 
					<!-- Text Button --> 
					<span class="txtBtn_lightGray"><a href="dasom_list.jsp" >목록으로</a></span> 
					<!-- Text Button --> 
				</div>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="이전글과 다음글의 제목으로 구성된 표 제목" class="prevNext">
					...
					<tr>
						<th scope="row">이전글</th>
						<td class="listx"><a href="#">종로다솜 &lt;통권 제11호&gt;</a></td>
					</tr>
					<tr>
						<th  scope="row">다음글</th>
						<td class="listx"><a href="#">종로다솜 &lt;통권 제13호&gt;</a></td>
					</tr>
				</table>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
