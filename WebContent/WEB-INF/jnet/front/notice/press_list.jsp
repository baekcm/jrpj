			...
			<div class="contents"> 
				...
				<div class="pageSection"> 
					...
					<div class="pageTopSearch">
						<form name="pgtSearch" method="post" action="/notice/press_list.jsp">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bd00 bd00Bbs" summary="번호,시설명, 분류, 제목, 조회수의 게시물의 목록표">
							...
							<tbody>
								<tr>
									<td>10</td>
									<td>종로구민회관</td>
									<td class="title"><a href="press_view.jsp">시정신문-종로구공단, '파도앙상블'문화나눔(20131017) </a></td>
									<td>1221</td>
								</tr>
								<tr>
									<td>9</td>
									<td>문화체육센터</td>
									<td class="title"><a href="press_view.jsp">위키트리-하루 30분, 이제는 운동도 스마트시대(20131002) </a></td>
									<td>23</td>
								</tr>
								<tr>
									<td>8</td>
									<td>청소년문화센터</td>
									<td class="title"><a href="press_view.jsp">시정신문-종로구공단, 추석연휴 주민 편의 주력(20130913) </a></td>
									<td>323</td>
								</tr>
								<tr>
									<td>7</td>
									<td>올림픽기념국민생활관</td>
									<td class="title"><a href="press_view.jsp">종로신문-종로구시설관리공단 ‘산업재해 제로’ 나선다(20130905) </a></td>
									<td>1221</td>
								</tr>
								<tr>
									<td>6</td>
									<td>삼청테니스장</td>
									<td class="title"><a href="press_view.jsp">위키트리-종로구시설관리공단 '작은음악회'호응(20130830) </a></td>
									<td>23</td>
								</tr>
								<tr>
									<td>5</td>
									<td>동부여성문화센터</td>
									<td class="title"><a href="press_view.jsp">종로신문-사진으로 본 1960년 창신동, "그때 그시절을 기억하시나요"(20130823) </a></td>
									<td>323</td>
								</tr>
								<tr>
									<td>4</td>
									<td>청소년문화센터</td>
									<td class="title"><a href="press_view.jsp">위키트리 - 주차신청도 모바일로 간편하게(20130813) </a></td>
									<td>222</td>
								</tr>
								<tr>
									<td>3</td>
									<td>문화체육센터</td>
									<td class="title"><a href="press_view.jsp">시정신문-종로구 공단, 주차장 안내지도 발행(20130724) </a></td>
									<td>222</td>
								</tr>
								<tr>
									<td>2</td>
									<td>종로구민회관</td>
									<td class="title"><a href="press_view.jsp">위키트리 - 종로구시설관리공단, 주차장 안내지도 발행(20130723) </a></td>
									<td>222</td>
								</tr>
								<tr>
									<td>1</td>
									<td>종로구민회관</td>
									<td class="title"><a href="press_view.jsp">이뉴스투데이 - 종로구시설관리공단, 역사체험연극'박물관은 살아있다'선보여(20130709) </a></td>
									<td>222</td>
								</tr>
							</tbody>
						</table>
...
<script type="text/javascript">initMenu(5,5,0,0);</script>
</body>
</html>