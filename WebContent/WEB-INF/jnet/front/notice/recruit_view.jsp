		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="boardWrap">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="제목,작성자를 포함한 게시물 상세보기의 표" class="bd00view">
						...
						<tr>
							...
							<td colspan="3" class="bd01td">채용공고</td>
						</tr>
						<tr>
							<th class="bd01th" scope="row">제목</th>
							<td colspan="3" class="bd01td listx">종로구시설관리공단 비상임이사 면접시험 일정 공고 </td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3" class="bd01td">면접시험공고안내.xls<img src="/resources/include/commonfile/image/board/b_ic_excel.gif" alt="파일형식별alt값" /></td>
						</tr>
						<tr>
							<td colspan="4" scope="row" class="bd01tdC"><p><img src="/resources/include/commonfile/image/attached/meeting_01.jpg" alt="제목을 alt값으로" /></p>
								<p>&nbsp;</p>
								<p>서울특별시종로구시설관리공단 임원(비상임이사) 공개채용에 따른  면접시험 일정을  다음과 같이 공고합니다.</p></td>
						</tr>
					</table>
				</div>
				<div class="btn_farm2 mt20 mb20"> 
					<!-- Text Button --> 
					<span class="txtBtn_lightGray"><a href="recruit_list.jsp" >목록으로</a></span> 
					<!-- Text Button --> 
				</div>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="이전글과 다음글의 제목으로 구성된 표 제목" class="prevNext">
					...
					<tr>
						<th scope="row">이전글</th>
						<td class="listx"><a href="#">[문화체육센터] 2013년 제37차 기간제계약직 (헬스지도, 회원관리) 공개채용 최종 합격자 발표 </a></td>
					</tr>
					<tr>
						<th  scope="row">다음글</th>
						<td class="listx"><a href="#">[종로구민회관] 2013년 종로구민회관 시급제계약직(주말안내) 채용계획 공고</a></td>
					</tr>
				</table>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
