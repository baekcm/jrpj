...
<div id="middle">
  <div id="contbody">
    ...
    <div id="contentcore">
      ...
      <div class="contents">
        <!-- real Contents -->
        <p class="mb30"><img src="/resources/include/commonfile/image/member/mhead05.gif" alt="종로구 시설관리공단 &quot;본인인증이 성공적으로 완료되었습니다. "/></p>
        <p class="btn_farm2 mt20 mb20"> <img src="/resources/include/commonfile/image/member/mhead03_check_ok.gif" alt="메인페이지 바로가기" /></a></p>
        <!-- real Contents -->
        <!--만족도 조사가 들어갈 영역 -->
        <!--만족도 조사가 들어갈 영역 -->
      </div>
