				...
				<div class="pageSection mb30">
					<c:choose>
						<c:when  test="${adult eq 'child'}">
							<h3 class="mb05"><img src="/resources/include/commonfile/image/member/title_join03_3.gif" alt="회원 본인 여부 확인" /></h3>
						</c:when>
						<c:otherwise>
				...
				<div class="memCerti">
					<div class="mcLeft">
						<ul class="guide">
							...
							<li class="btn"><a href="#"><img title="새 창 열림" src="/resources/include/commonfile/image/member/btn_ansim.gif" id="checkAuthBtn" alt="안심체크 인증" /></a></li>
						</ul>
					</div>
					<div class="mcRight">
						<ul class="guide">
							...
							<li class="btn"><a href="#"><img title="새 창 열림" src="/resources/include/commonfile/image/member/btn_ipin.gif" id="ipinAuthBtn" alt="아이핀(I-pin)인증" /></a></li>
						</ul>
					</div>
				</div>
