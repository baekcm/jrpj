...
$("#findId").click(function(){
	...
	$.ajax({
        ...
        dataType : "json",
        data:  {"userNm" : $("#userNm").val(),"email" : $("#email").val(),"userId" : $("#userId").val()},
...
<script type="text/javascript">
			...
			function doRequestUsingPOST1() {
	        	...
	        	%>
					...
					xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;");
					var p_value = XecureAjaxPost(XecureMakePlain(document.f2));
					xmlHttp.send(p_value);
					return false;
	        	<%
				}
		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="loginBox bg_memPw" style="height:480px;">
					...
					<div class="loginText2 txColor">회원 가입 시 입력한 정보를 정확히 입력해 주시기 바랍니다.</div>
					...
					<form action="#" name="f1">
							<ul id="showUl" >
								<li>
									<dl>
										<dt>
											<label for="userId"><img src="/resources/include/commonfile/image/member/title_id.gif" alt="회원Id" /></label>
										</dt>
										<dd>
											<input name="userId" id="userId" type="text" title="회원Id 입력" />
										</dd>
									</dl>
								</li>
								<li>
					...
					<div class="btn_go"><a href="#"><img id="findId" src="/resources/include/commonfile/image/member/btn_searchpw.gif" alt="비번 찾기" /></a></div>
					<div class="btn_go"><a href="#"><img alt="변경" id="changBtn" src="/resources/include/commonfile/image/member/bg_btn_change.gif" /></a></div>
				</div>
