				...
				<div class="pageSection"> 
					...
					<div class="tblWrap">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="프로그램별 요일, 시간, 대상, 회비,접수 유무를 나열한 표. " class="tbl01 tdCenter">
							...
							<tr>
								<td>1</td>
								<td><a href="../stennis/freexp_view.jsp">06시 해오름 수영 A</a></td>
								<td>월 수 금</td>
								<td>06:00~06:50</td>
								<td>성인남녀</td>
								<td>49,500원</td>
							...
							<tr>
								<td>2</td>
								<td><a href="../stennis/freexp_view.jsp">06시 해오름 수영 B</a></td>
								<td>화 목 토</td>
								<td>06:00~06:50</td>
								<td>성인남녀</td>
								<td>49,500원</td>
...
<script type="text/javascript">initMenu(1,6,2,3);</script>
</body>
</html>