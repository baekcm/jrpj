		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="btn_farm2 mt20 mb20"> 
					<!-- Text Button --> 
					<span class="txtBtn_lightGray"><a href="../olympic/lost_list.jsp" >작성</a></span> &nbsp;
					<span class="txtBtn_lightGray"><a href="../olympic/lost_list.jsp" >취소</a></span> 
					<!-- Text Button --> 
				</div>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
...
<script type="text/javascript">initMenu(1,5,1,5);</script>
</body>
</html>