	...
	<div id="contbody">
		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<div class="btn_farm2"> <a href="../youth/program_cart.jsp"><img src="/resources/include/commonfile/image/board/btn_onlineapply.gif" alt="온라인 신청" /></a> </div>
				<!-- real Contents --> 
				<!--만족도 조사가 들어갈 영역 -->
...
<script type="text/javascript">initMenu(1,5,2,3);</script>
</body>
</html>