				...
				<div class="pageSection"> 
					...
					<div class="tblWrap mb30">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="강좌명, 시간,요일, 대상, 단가, 할인적용, 할인금액, 결젝금액을 나타낸 표 " class="tbl01 tdCenter">
							...
							<tr>
								<td><a href="../youth/sports_view.jsp">06시 해오름 수영 A</a>(월~토)</td>
								<td><a href="../youth/sports_view.jsp">06:00~06:50</a></td>
								<td>월 ~ 토</td>
								<td>성인남/여</td>
								<td>80,300</td>
							...
							<tr>
								<td><a href="../youth/sports_view.jsp">06시 해오름 수영 A</a>(화수목)</td>
								<td><a href="../youth/sports_view.jsp">06:00~06:50</a></td>
								<td>화,수,목</td>
								<td>성인남/여</td>
								<td>49,500</td>
					...
					<div class="btn_farm2 mt20 mb20"> 
						<!-- Text Button --> 
						<span class="txtBtn_lightGray"><a href="../youth/sports_list.jsp" >강좌목록</a></span> 
						<!-- Text Button --> 
						<!-- Text Button --> 
						<span class="txtBtn_Gray"><a href="../youth/sports_list.jsp" >결제하기</a></span> 
						<!-- Text Button --> 
					</div>
				</div>
...
<script type="text/javascript">initMenu(1,5,2,0);</script>
</body>
</html>