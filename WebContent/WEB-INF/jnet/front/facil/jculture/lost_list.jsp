	...
	<div id="contbody">
		...
		<div id="contentcore">
			...
			<div class="contents"> 
				...
				<!-- real Contents -->
				<div class="pageIntro">
					<p><strong>※ 분실물은 습득 후 한달 간 보관하며, 그 이후는 자동 처분 됩니다.
							<br />
				...
				<div class="pageSection">
					...
					<ul class="thumbList">
						<li>
							<dl>
								...
								<dt><a href="../jculture/lost_view.jsp">명품화 짝퉁가방과 지갑. 지갑속에 포인트 카드 다수.</a></dt>
					...
					<div class="pgeAbs mt30"> 
						...
						<div class="frBtn"> 
							<!-- Text Button --> 
							<span class="txtBtn_Gray"><a href="lost_write.jsp" >글쓰기</a></span> 
							<!-- Text Button --> 
						</div>
					</div>
					<!-- board paging --> 
...
<script type="text/javascript">initMenu(1,3,1,5);</script>
</body>
</html>