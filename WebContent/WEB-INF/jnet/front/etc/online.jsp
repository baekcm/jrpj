...
$(document).ready(function(e) {
	...
	$('.onlineGuide .faqa > a').toggle(
		function(){
			$(this).parent(this).parent().find('.faqq').css('display','block');
		},
		function(){
			$(this).parent(this).parent().find('.faqq').css('display','none');
		}
	);
});
</script> 
...
<script type="text/javascript">initMenu(10,5,0,0);</script>
</body>
</html>