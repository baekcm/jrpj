...
<div class="regiArea">
    <ul class="formarea">
        ...
        <li class="second">
            ...
            <select name="ri" id="ri" style="width:111px;">
                <option value="">선택</option>
            </select>
            <input type="checkbox" name="san" id="san" value="" /><label for="san">산</label>
        </li>
        <li class="first">
            <label class="title" for="bunji1">번지</label>
            <input type="text" name="bunji1" id="bunji1" maxlength="10" style="width:64px; ime-mode:active" class="inputText" onkeydown="javascript:sendkeydown();" /> -
            <input type="text" name="bunji2" id="bunji2" maxlength="10" style="width:64px; ime-mode:active" class="inputText" onkeydown="javascript:sendkeydown();" />
        </li>
    </ul>
