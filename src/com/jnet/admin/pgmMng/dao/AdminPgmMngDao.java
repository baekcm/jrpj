package com.jnet.admin.pgmMng.dao;
...
public interface AdminPgmMngDao {
	/**
	 * 외부프로그램 목록수 조회
	 * @return int int
	 ...
	 * @return int int
	 */
	public abstract int savePgmMng(TeacherImg teacherImgParam) throws SQLException ;
	...
	/**
	 * 프로그램 - 강사 저장
	 * @param teacherImgParam
	 */
	public abstract void savePgmTeacher(TeacherImg teacherImgParam) throws SQLException ;
	
	/**
	 * 프로그램 - 강사 삭제
	 * @param teacherImgParam teacherImgParam
	 */
	public abstract void removePgmTeacher(TeacherImg teacherImgParam) throws SQLException ;

	/**
	 * 프로그램 - 대표이미지 저장
	 * @param teacherImgParam teacherImgParam
	 */
	public abstract void savePgmImg(TeacherImg teacherImgParam) throws SQLException ;

	/**
	 * 프로그램 대표이미지 삭제
	 * @param teacherImgParam
	 */
	public abstract void removePgmImg(TeacherImg teacherImgParam) throws SQLException ;
	 ...
	 * @throws SQLException SQLException
	 */
	public abstract int saveTeacherMng(TeacherImg teacherImgParam) throws SQLException;
	 ...
	 * @throws SQLException SQLException
	 */
	public abstract void saveTeacherImg(TeacherImg teacherImgParam) throws SQLException;
	 ...
	 * @throws SQLException SQLException
	 */
	public abstract void removeTeacherImg(TeacherImg teacherImgParam) throws SQLException;
	 ...
	 * @throws SQLException SQLException
	 */
	public abstract ArrayList<TeacherImg> listTeacherImgByFileSeq(TeacherImg teacherImgParam) throws SQLException;
