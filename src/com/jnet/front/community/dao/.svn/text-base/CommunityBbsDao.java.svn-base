package com.jnet.front.community.dao;
...
public interface CommunityBbsDao {
	 ...
	 * @throws SQLException SQLException
	 */
	public abstract int saveCommunityData(BbsFileReply bbsParam) throws SQLException;
	 ...
	 * @throws SQLException SQLException
	 */
	public abstract void saveCommunityFile(BbsFileReply bbsFile) throws SQLException;
	 ...
	 * @throws SQLException SQLException
	 */
	public abstract void removeCommunityFile(BbsFileReply bbsParam) throws SQLException;
	 ...
	 * @throws SQLException SQLException
	 */
	public abstract int saveCommunityCommentData(BbsFileReply bbsParam) throws SQLException;
